...
\begin{Q}
    \begin{enumerate}
        \item Using the provided template, implement a simple neural network that can process inputs.
            Implement the backpropagation algorithm is order to train your network.
        \item Separate the provided dataset in training set and test set and train your network.
        \item Evaluate the performance of your network on the training set and test set, are the results different ? why ?
    \end{enumerate}
    \reponse{
...
\begin{Q}
    Use tensorflow with keras o instanciate, train and test the same network as in the
    previous question.
